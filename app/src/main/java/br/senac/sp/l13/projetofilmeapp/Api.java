package br.senac.sp.l13.projetofilmeapp;

/**
 * Created by laercio.nsilva on 13/04/2018.
 */

public class Api {

    private static final String ROOT_URL = "http://10.23.49.24:8080/HeroApi/v1/Api.php?apicall=";
